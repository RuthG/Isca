...
exp = Experiment('ts_ozone_test_experiment', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'two_stream_gray_rad_nml': {
        'rad_scheme': 'geen',            #Select radiation scheme to use, which in this case is Geen
        ...
        'ozone_variable_name': 'ozone_1990'
    },
